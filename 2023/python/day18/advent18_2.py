...
def main(file: str) -> int:
    ...
    for i in range(len(maps)):
        energy_map = iterative(maps, (2,(i,-1)))
        total = count_energy(energy_map)
        if total > lowest_energy:
            lowest_energy = total
    for i in range(len(maps[0])):
        energy_map = iterative(maps, (3,(len(maps),i)))
        total = count_energy(energy_map)
        if total > lowest_energy:
            lowest_energy = total
    for i in range(len(maps)):
        energy_map = iterative(maps, (0,(i,len(maps[0]))))
        total = count_energy(energy_map)
        if total > lowest_energy:
            lowest_energy = total
    for i in range(len(maps[0])):
        energy_map = iterative(maps, (1,(-1,i)))
        total = count_energy(energy_map)
        if total > lowest_energy:
            lowest_energy = total
